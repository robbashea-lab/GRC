...
class FrameworkTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_selection_combinations_and_no_implicit_retrofit(self):
        ...
        for programs in ([],['hipaa'],['iso-27001','soc-2'],['cis-ig1'],['cis-ig1','hipaa','nist-csf-2']):
            ...
            review_count=19 if 'nist-csf-2' in programs else 18 if expected and 'hipaa' in programs else 12 if expected else 8 if 'hipaa' in programs else 13 if 'iso-27001' in programs else 0
            ...
            for key in ['hipaa','nist-csf-2','iso-27001','cmmc','soc-2']:
                ...
                count={'hipaa':76,'iso-27001':123,'soc-2':33,'nist-csf-2':106}.get(key,0) if key in programs else 0
