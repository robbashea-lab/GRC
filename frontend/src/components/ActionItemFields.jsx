...
export default function ActionItemFields({form,setForm,record,clientId,canWrite,onTransition,saving,sourceLocked=false,related={},onOpen}) {
  ...
  return <div className="space-y-4">
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div><Label>Assignee</Label><AssigneeSelect clientId={clientId} label="Assignee" value={form.assignee_id} onChange={v=>change('assignee_id',v)} users={data.users} disabled={!canWrite}/></div>
